        ...
        <div className={styles.footerTop}>
          <div className={styles.about}>
            ...
            <p>
              ...
              aperiam delectus provident iusto esse voluptas ipsa sequi
              doloremque. Voluptate facere exercitationem eius laborum sunt
              dicta sapiente dolorum maxime magni corporis?
            </p>
            <div className={styles.contact}>
              <p>
                <span>Email: </span>info@metablog.com
              </p>
              <p>
          ...
          <div className={styles.bottomLeft}>
            ...
            <div className={styles.copyright}>
              ...
              <div className={styles.copyrightInfo}>
                MetaBlog 2024. All Rights Reserved
              </div>
            </div>
          </div>
